...
public class TileImageViewAdapter implements TileImageView.TileSource {
    ...
    public TileImageViewAdapter(Context activity) {
        mActivity = activity;
    }
    ...
    public Bitmap getTile(int level, int x, int y, int tileSize) {
        ...
        Bitmap bitmap = GalleryBitmapPool.getInstance(mActivity).get(tileSize, tileSize);
        if (bitmap != null) {
        ...
        try {
            ...
            if (options.inBitmap != bitmap && options.inBitmap != null) {
                GalleryBitmapPool.getInstance(mActivity).put(options.inBitmap);
    ...
    private Bitmap replaceBackgroudForTile(Bitmap bitmap, int level, int x, int y, int tileSize) {
        int t = tileSize << level;
        Rect wantRegion = new Rect(x, y, x + t, y + t);
        ...
        return BitmapUtils.replaceBackgroundColor(
                bitmap,
                true,
