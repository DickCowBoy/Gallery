...
public class GLView {
    ...
    public void startAnimation(CanvasAnimation animation) {
        ...
        if (root == null) {
            Log.e(TAG,"start Animation fail for root is null");
            return;
        };
    ...
    public boolean containComponent(GLView componnt){
        if(componnt != null){
            return mComponents.contains(componnt);
        }
        return false;
    }
    ...
    public boolean isLayoutRtl(){
        return mRoot == null? isRTLlayout : mRoot.isLayoutRtl();
    }
