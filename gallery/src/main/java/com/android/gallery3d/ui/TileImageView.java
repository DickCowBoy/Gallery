...
public class TileImageView extends GLView {
    ...
    public TileImageView(GLHost activity) {
        mGLHost = activity;
        /// M: [PERF.MODIFY] @{
    ...
    public void setModel(TileSource model) {
        mModel = model;
        // TODO LJL check whether need if (model != null) notifyModelInvalidated();
    }
...
//                }
        ...
        synchronized (this) {
            if (tile.mTileState == STATE_RECYCLING) {
                ...
                if (tile.mDecodedTile != null) {
                    GalleryBitmapPool.getInstance(mGLHost.getContext()).put(tile.mDecodedTile);
    ...
    private class Tile extends UploadedTexture {
        ...
        protected void onFreeBitmap(Bitmap bitmap) {
            GalleryBitmapPool.getInstance(mGLHost.getContext()).put(bitmap);
        }
        ...
        protected Bitmap onGetBitmap() {
            ...
            Utils.assertTrue((mTileState == STATE_DECODED) || (mTileState == STATE_ACTIVATED));
