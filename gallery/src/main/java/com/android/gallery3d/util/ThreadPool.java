...
public class ThreadPool {
    ...
    /// M: [BUG.ADD] CPU_CORES_NUM:Dynamic control thread number according to CPU Cores from constant number,
    ...
    ResourceCounter mNetworkCounter = new ResourceCounter(PARALLEL_THREAD_NUM);
    /// @}
    ...
    public ThreadPool(int initPoolSize, int maxPoolSize) {
        /// M: [PERF.MODIFY] @{
        // To avoid the thread pool in runnable status for a long time,
        // improve the priority of thread pool.
