...
import com.android.gallery3d.cache.MemorySizeCalculator;
...
public class GalleryBitmapPool {
    ...
    public static final int CAPACITY_BYTES = 20971520;
    ...
    private Pool<SparseArrayBitmapPool.Node> mSharedNodePool = new SynchronizedPool<SparseArrayBitmapPool.Node>(128);
    ...
    public synchronized static GalleryBitmapPool getInstance(Context context) {
        if(sInstance == null){
            sInstance = new GalleryBitmapPool(MemorySizeCalculator.get(context).getBitmapPoolSize());
        }
        return sInstance;
    }
